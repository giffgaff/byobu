...
function (_UserPage) {
  ...
  _proto.show = function show(user) {
    ...
    this.list.refresh(); // We call the parent method after creating the list, this way the this.list propert
  ...
  _proto.content = function content() {
    ...
    }, m("li", null, flarum_components_Button__WEBPACK_IMPORTED_MODULE_3___default.a.component({
    ...
    }, m("li", null, flarum_components_Dropdown__WEBPACK_IMPORTED_MODULE_4___default.a.component({
      buttonClassName: 'Button',
