...
var RecipientsModified = /*#__PURE__*/function (_EventPost) {
  ...
  RecipientsModified.initAttrs = function initAttrs(attrs) {
    ...
    var content = attrs.post.content();
...
/* harmony import */ var flarum_states_DiscussionListState__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! flarum/states/DiscussionListState */ "flarum/states/DiscussionListState");
/* harmony import */ var flarum_states_DiscussionListState__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(flarum_states_DiscussionListState__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var _pages_labels_recipientsLabel__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../pages/labels/recipientsLabel */ "./src/forum/pages/labels/recipientsLabel.js");
/* harmony import */ var flarum_utils_DiscussionControls__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! flarum/utils/DiscussionControls */ "flarum/utils/DiscussionControls");
/* harmony import */ var flarum_utils_DiscussionControls__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(flarum_utils_DiscussionControls__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var flarum_utils_ItemList__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! flarum/utils/ItemList */ "flarum/utils/ItemList");
/* harmony import */ var flarum_utils_ItemList__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(flarum_utils_ItemList__WEBPACK_IMPORTED_MODULE_12__);
...
var add = function add(discussion, items, _long) {
  ...
  if (recipients && recipients.length) {
    if (_long) {
      items.add('recipients', Object(_pages_labels_recipientsLabel__WEBPACK_IMPORTED_MODULE_10__["default"])(recipients), 10);
    } else {
      items.add('recipients', Object(_pages_labels_recipientsLabel__WEBPACK_IMPORTED_MODULE_10__["default"])(recipients, {
        link: true
      }), 4);
    }
  }
...
function index() {
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_DiscussionListItem__WEBPACK_IMPORTED_MODULE_6___default.a.prototype, 'infoItems', function (items) {
...
function apiInclude() {
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_DiscussionPage__WEBPACK_IMPORTED_MODULE_7___default.a.prototype, 'params', function (params) {
    params.include.push('recipientUsers');
  });
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_states_DiscussionListState__WEBPACK_IMPORTED_MODULE_9___default.a.prototype, 'requestParams', function (params) {
    params.include.push('recipientUsers');
  });
}

function controls() {
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_utils_DiscussionControls__WEBPACK_IMPORTED_MODULE_11___default.a, 'moderationControls', function (items, discussion) {
    ...
    if (discussion && discussion.recipientUsers().find(function (user) {
      ...
      items.add('remove', flarum_components_Button__WEBPACK_IMPORTED_MODULE_5___default.a.component({
        ...
        onclick: function onclick() {
          if (discussion) {
            var recipients = new flarum_utils_ItemList__WEBPACK_IMPORTED_MODULE_12___default.a();
...
function addToSessionDropdown() {
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_SessionDropdown__WEBPACK_IMPORTED_MODULE_9___default.a.prototype, 'items', function (items) {
    if (!app.session.user) return;
    var href = app.route('byobuUserPrivate', {
      username: app.session.user.username()
    });
    items.add('session-pd-link', flarum_components_LinkButton__WEBPACK_IMPORTED_MODULE_8___default.a.component({
      href: href,
      icon: app.forum.data.attributes['byobu.icon-badge']
...
var PrivateComposing = /*#__PURE__*/function () {
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_0__["default"])(PrivateComposing, [{
    ...
    get: function get() {
      var canStart = app.session.user && app.forum.attribute('canStartPrivateDiscussion');
...
function recipientLabel(recipient, attrs) {
  ...
  return flarum_components_LinkButton__WEBPACK_IMPORTED_MODULE_3___default.a.component(attrs, label);
}
...
/* harmony import */ var _pages_labels_recipientLabel__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../pages/labels/recipientLabel */ "./src/forum/pages/labels/recipientLabel.js");
/* harmony import */ var flarum_models_User__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! flarum/models/User */ "flarum/models/User");
/* harmony import */ var flarum_models_User__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(flarum_models_User__WEBPACK_IMPORTED_MODULE_8__);
...
var RecipientSearch = /*#__PURE__*/function (_Search) {
  ...
  _proto.view = function view() {
    ...
    return m('div', {
      ...
      return Object(_pages_labels_recipientLabel__WEBPACK_IMPORTED_MODULE_7__["default"])(recipient, {
        onclick: function onclick(e) {
          return _this2.removeRecipient(recipient, e);
        }
      });
    })), m('input', {
      className: 'RecipientsInput FormControl ' + flarum_utils_classList__WEBPACK_IMPORTED_MODULE_4___default()({
      ...
      type: 'search',
      placeholder: flarum_utils_extractText__WEBPACK_IMPORTED_MODULE_5___default()(app.translator.trans('fof-byobu.forum.input.search_recipients')),
      ...
      className: 'Dropdown-menu Search-results fade ' + flarum_utils_classList__WEBPACK_IMPORTED_MODULE_4___default()({
        "in": !!loading
      })
    }, !this.doSearch ? flarum_components_LoadingIndicator__WEBPACK_IMPORTED_MODULE_6___default.a.component({
      size: 'tiny',
  ...
  _proto.sourceItems = function sourceItems() {
    var items = new flarum_utils_ItemList__WEBPACK_IMPORTED_MODULE_3___default.a(); // Add user source based on permissions.
